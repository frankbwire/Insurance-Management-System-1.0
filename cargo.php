        ...
        <div class="container">
                ...
                <div class="col-lg-8 posts-list">
                    <div class="single-post">
                        ...
                        <div class="blog_details">
                              <h1 style="color: black">Cargo Insurance</h1>
          ...
          <!--Comment Area-->
                    <div class="comment-form">
                        <h4>Leave a Reply</h4>
                        <form class="form-contact comment_form" action="cargo.php" method="post" id="commentForm">
                            <div class="row">
                                <div class="col-12">
                            ...
                            <ul class="list cat-list">
                                ...
                                <li>
                                    <a href="cargo.php" class="d-flex">
                                        <p style="color: #f84b67">Cargo Insurance</p>
